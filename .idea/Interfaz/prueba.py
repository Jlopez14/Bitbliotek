...
class MyApp(App):
    def build(self):
        ...
        # Campo de usuario
        user_input = TextInput(hint_text='Usuario', multiline=False, size_hint=(None, None), pos_hint={'center_x': 0.5, 'center_y': 0.5 - img_spacing + total_spacing / 2}, size=(dp(300), dp(40)))
        center_layout.add_widget(user_input)

        # Campo de contraseña
        password_input = TextInput(hint_text='Contraseña', multiline=False, password=True, size_hint=(None, None), pos_hint={'center_x': 0.5, 'center_y': 0.5 - img_spacing - input_spacing + total_spacing / 2}, size=(dp(300), dp(40)))
